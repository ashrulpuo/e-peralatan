...
if(isset($_POST['submit']))
{
	...
	{				
		...
		<script type="text/javascript">
			alert(" Permohonan Anda Direkodkan, Sila datang ke BICT untuk pengambilan aset dan maklumkan kepada Staff BICT (Puan Nura/ Encik Isham)");
							...
							<form method="POST" action="<?php echo $_SERVER['REQUEST_URI'];?>" onSubmit="window.location.reload()">
								...
								<div class="form-group row">
									...
									<div class="form-group row">
										...
										1</font></label>
										<div class="col-sm-8">
											<select name="peralatan1" class="form-control">
									...
									<div class="form-group row">
										...
										2</font></label>
										<div class="col-sm-8">
											<select name="peralatan2" class="form-control">
												<option value="Tiada">--- Sila pilih ---</option>
												<?php
									...
									<div class="form-group row">
										...
										3</font></label>
										<div class="col-sm-8">
											<select name="peralatan3" class="form-control">
												<option value="Tiada">--- Sila pilih ---</option>
												<?php
